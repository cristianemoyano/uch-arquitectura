...
const profileNavigationActiveUser = [
    {name: 'Perfil', href: '/admin/userProfile', current: false},
    {name: 'Sign Out', href: '#', current: false},]

const profileNavigationNoActiveUser = [
...
export default function Navbar() {
    ...
    const currentUserState = useProfileContext();
                                ...
                                <Menu as="div" className="relative ml-3">
                                    ...
                                    >
                                        <Menu.Items
                                            ...
                                            {
                                                currentUserState.profile && currentUserState.profile.email ?
                                                    profileNavigationActiveUser.map((item) => (
                                                    ...
                                                    ) : profileNavigationNoActiveUser.map((item) => (
                                                        <Menu.Item key={item.name}>
                                                            <Link
                                                                key={item.name}
                                                                href={item.href}

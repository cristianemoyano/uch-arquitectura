  ...
  <div className="grid min-h-screen grid-cols-10">
    <div className="col-span-full py-6 px-4 sm:py-12 lg:col-span-6 lg:py-24">
      <div className="mx-auto w-full max-w-lg">
        <h1 className="relative text-2xl font-medium text-white sm:text-3xl">Checkout<span className="mt-2 block h-1 w-10 bg-teal-600 sm:w-20"></span></h1>
          ...
          <div>
            ...
            <div className="mr-6 flex flex-wrap">
              <div className="my-1">
                ...
                ><select name="month" id="month" className="cursor-pointer rounded border-gray-300 bg-black py-3 px-2 text-sm shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500">
              ...
              <div className="my-1 ml-3 mr-6">
                ...
                ><select name="year" id="year" className="cursor-pointer rounded border-gray-300 bg-black py-3 px-2 text-sm shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500">
              ...
              <div className="relative my-1"><label htmlFor="security-code" className="sr-only">Security code</label><input type="text" id="security-code" name="security-code" placeholder="Codigo de seguridad" className="block w-360 rounded bg-black border-gray-300 bg-gray-50 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500" /></div>
            </div>
          </div>
          <div><label htmlFor="card-name" className="text-xs font-semibold text-gray-500">Nombre en la tarjeta</label><input type="text" id="card-name" name="card-name" placeholder="Juan Perez" className="mt-1 block w-full rounded border-gray-300 bg-black py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500" /></div>
        </form>
        
        <button type="submit" className="mt-4 inline-flex w-full items-center justify-center rounded bg-teal-600 py-2.5 px-4 text-base font-semibold tracking-wide text-white text-opacity-80 outline-none ring-offset-2 transition hover:text-opacity-100 focus:ring-2 focus:ring-teal-500 sm:text-lg">Confirmar pedido</button>
      </div>
    </div>
    <div className="relative col-span-full flex flex-col py-6 pl-8 pr-4 sm:py-12 lg:col-span-4 lg:py-24">
      ...
      <div>
        ...
        <div className="absolute inset-0 h-full w-full z-[-1] bg-gradient-to-t from-teal-800 to-teal-400 opacity-95"></div>
      </div>
